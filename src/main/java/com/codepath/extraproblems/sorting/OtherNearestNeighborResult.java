...
class OtherNearestNeighborResult {
    /*============================== START =========================================*/
...
class OtherNearestNeighborResultSolution {
    ...
    public static void solve() throws IOException {
        ...
        List<List<Integer>> result = OtherNearestNeighborResult.nearest_neighbours(p_x, p_y, k, n_points);
